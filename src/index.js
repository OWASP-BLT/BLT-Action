...
const run = async () => {
    try {
        ...
        // Assignment keywords
        const assignKeywords = ['/assign', 'assign to me', 'assign this to me', 'please assign me this', 'i can try fixing this', 'i am interested in doing this', 'be assigned this', 'i am interested in contributing'];
